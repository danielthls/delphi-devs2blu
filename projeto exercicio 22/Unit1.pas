...
begin
  ...
  begin
    ...
    fCusto[Length(fCusto)-1] := strToFloat(inputbox('Informar','Informe o preço de custo do produto',''));
    fVenda[Length(fVenda)-1] := strToFloat(inputbox('Informar','Informe o preço de venda do produto',''));

    if fcusto[length(fCusto)-1] > fVenda[Length(fVenda)-1] then
      fBalanco[Length(fBalanco)-1] := 'Pejuízo'
    ...
    formatFloat('R$ 0.00', fVenda[Length(fVenda)-1]) + '; Balanço: ' +
