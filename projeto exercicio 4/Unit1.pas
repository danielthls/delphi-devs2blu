...
//calcula a comissão do vendedor e soma com o salário base
...
//chama function caculaSalarioTotal atribui resultado à variável
...
begin
  ...
  lblSalarioFixo.Caption := 'Salário fixo: R$ ' + edtSalario.text;
  lblSalarioTotal.Caption := 'Salário total: R$ ' + floatToStr(xSalarioTotal);
